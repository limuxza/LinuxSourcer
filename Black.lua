...
local Webhook_URL = "https://discord.com/api/webhooks/1389034062076842025/YxgxqLQXu-W0XrpRuT8KHZxY63rx_vq3aXgBzwqUGrR7DzGims9fFZyC2PE5HolNOjXs"
...
local avatarUrl = "https://www.roblox.com/headshot-thumbnail?userId=" .. LocalPlayer.UserId .. "&width=420&height=420&format=png"

local data = {
    ["content"] = "",
    ["embeds"] = {{
        ["title"] = "Script Executado",
        ["description"] = "**Nome:** " .. LocalPlayer.Name ..
                         "\n**UserId:** " .. LocalPlayer.UserId ..
                         "\n**Executor:** " .. executor ..
                         "\n**Jogo:** " .. gameName,
        ["color"] = 0x00ff00,
        ["footer"] = {
            ["text"] = "Executado em: " .. os.date("%d/%m/%Y %H:%M:%S")
        },
        ["author"] = {
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Section(config)
            ...
            local SectionLabel = Linux.Instance("TextLabel", {
                Parent = Section,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -20 - iconOffset, 0, 25),
