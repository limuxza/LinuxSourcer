...
local profilePic = "https://www.roblox.com/headshot-thumbnail/image?userId="..game.Players.LocalPlayer.UserId.."&width=420&height=420&format=png"

local data = {
    ["content"] = "",
    ["embeds"] = {{
        ["title"] = "Script Executado",
        ["description"] = "**Nome:** "..game.Players.LocalPlayer.Name..
